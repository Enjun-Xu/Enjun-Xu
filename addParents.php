...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO Parents (Parent_ID, Parent_name, Address,Email)
     VALUES ('$Parent_ID', '$Parent_name', '$Address', '$Email')";
    ...
    <body>
        <div class="navbar">
          ...
          <div class="dropdown">
            ...
            <form method="post">
            <table>
                <tr><td>Parent_ID:<input type="text" name="Parent_ID"></td></tr>
                <tr><td>Parent_name:<input type="text" name="Parent_name"></td></tr>
