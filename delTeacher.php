...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql2 = "delete FROM `Teachers` WHERE Teacher_ID ='$id';";
    $re = mysqli_query($link,$sql2);
    if($re){
       echo "<script>javascript:alert('yes!');location.href='delTeacher.php';</script>";
    }else{
       echo "<script>javascript:alert('no!');location.href='delTeacher.php';</script>";
    }
...
<h3>See all Teachers</h3>
		...
		<table>
			...
			<tr>
                ...
                <th><a href='delTeacher.php?id=".$row['Teacher_ID']."'>del</a></th>
