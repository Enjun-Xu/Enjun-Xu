...
$link = mysqli_connect("localhost", "root", "", "PrimarySchool");
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO Classes (Class_ID, Class_name, Pupils_num,Teacher_name)
        VALUES ('$Class_ID', '$Class_name', '$Pupils_num', '$Teacher_name')";
    ...
    <body>
        <div class="navbar">
          ...
          <div class="dropdown">
            ...
            <form method="post">
            <table>
                <tr><td>Class_ID:<input type="text" name="Class_ID"></td></tr>
                <tr><td>Class_name:<input type="text" name="Class_name"></td></tr>
                <tr><td>Pupils_num:<input type="text" name="Pupils_num"></td></tr>
                <tr><td>Teacher_name:<select name="Teacher_name"><?php  
